...
#copy the test file
cp test_cases/checks/input07.txt working_dir/input.txt
cp test_cases/checks/output07.txt working_dir/
...
cp "$testDir/python3/$testSetup/executeTest8.sh" working_dir/executeTest.sh	#source path defaults to "test_cases/python3/setup"
