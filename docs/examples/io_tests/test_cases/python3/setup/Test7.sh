...
#copy the test file
cp test_cases/checks/input06.txt working_dir/input.txt
cp test_cases/checks/output06.txt working_dir/
...
cp "$testDir/python3/$testSetup/executeTest7.sh" working_dir/executeTest.sh	#source path defaults to "test_cases/python3/setup"
