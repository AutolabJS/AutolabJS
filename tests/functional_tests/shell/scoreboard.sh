...
kill -SIGINT "$msPid" > /dev/null 2>&1
cd ../../main_server
./node_modules/.bin/istanbul cover --dir="coverage_${TEST_TYPE:0:-3}_1" --handle-sigint main_server.js >>/tmp/log/main_server.log 2>&1 &
msPid="$!"
sleep 5
...
kill -SIGINT "$msPid" > /dev/null 2>&1
cd ../../main_server
./node_modules/.bin/istanbul cover --dir="coverage_${TEST_TYPE:0:-3}_2" --handle-sigint main_server.js >>/tmp/log/main_server.log 2>&1 &
msPid="$!"
